 ...
 * <a href="https://github.com/apache/curator/blob/master/curator-examples/src/main/java/discovery/DiscoeryExample.java">DiscoveryExample. java</a>
 *
 * Zookeeper 注册中心
 */
@Slf4j
public class ZookeeperRegistry implements Registry{
    ...
    public void init(RegistryConfig registryConfig) {
        ...
        serviceDiscovery = ServiceDiscoveryBuilder.builder(ServiceMetaInfo.class)
                ...
                .serializer(new JsonInstanceSerializer<ServiceMetaInfo>(ServiceMetaInfo.class))
                .build();
    ...
    public List<ServiceMetaInfo> serviceDiscovery(String serviceKey) {
        ...
        if (null != cachedServiceMetaInfoList) {
    ...
    public void heartBeat() {
        // 不需要心跳机制，建立了临时节点，如果服务器故障，则临时节点直接丢弃
    }
